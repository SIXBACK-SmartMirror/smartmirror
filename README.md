...
<p align="center"><img src="./image/main_image.png" alt="main_image.png" width="60%"/></p>
...
<ul>
    ...
    <ul>
        <li>UI 개발
            <ul>
                <li>원클릭 화장, 커스텀 화장 등 모든 UI 설계 및 개발</li>
                <li>사용자 친화적인 인터페이스 구현</li>
            </ul>
        </li>
        <li>검색 기능 개발
            <ul>
                <li>음성 녹음 기능을 통한 제품 검색 지원</li>
                <li>화상 키보드를 활용한 터치 기반 검색</li>
                <li>검색된 제품의 상세 정보와 추천 화장품 제공</li>
            </ul>
        </li>
    </ul>
</li>
